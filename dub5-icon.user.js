...
GUI.style.background = 'linear-gradient(to bottom, #000022, #000066)';
  ...
  let footer = document.createElement('div'); bodyDiv.appendChild(footer); footer.style.fontSize = '0.9rem'; footer.style.paddingBottom = '5px'; footer.innerHTML = '<a href="https://dub55.github.io/" target="_blank"><img src="https://github.com/DUB55/dub55.github.io/blob/main/dub5.png?raw=true" style="width: 40px; height: auto; cursor: pointer;" alt="DUB5 Icon"></a>';
